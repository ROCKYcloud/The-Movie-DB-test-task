...
object Constants {
    ...
    const val API_TOKEN = "eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJhOWNmYWJiZTUyN2E2MTExYWIyZjVjMWQ1ZmE4ZjNmMyIsInN1YiI6IjY1MWJjNTg5YzUwYWQyMDEwYmZmNGMxYSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.gcIUonMVa7Q2r92rgvbo-RyvigSnP_VO4LMQ9KJvTPM"
    const val error = "ERROR"
    const val accountId = 20523672
    const val like = "Like"
